...
describe('/players/top-players', () => {
  ...
  it('shows cards in correct order (by points)', () => {
    ...
    cy.get('@cards')
      .eq(5)
      .should('contain', 'Blake Coleman')
    cy.get('@cards')
      .eq(6)
      .should('contain', 'Dan Hamhuis')
    cy.get('@cards')
      .eq(14)
      .should('contain', 'Alex DeBrincat')
  })
