...
const PrivacyPolicy = () => {
  return (
    <PageContainer title="GDPR">
      <ContentWrapper>
        <Title>Privacy Policy for Player Fan</Title>
        <Paragraph>
          At Player Fan, accessible from player.fan, one of our main priorities
          is the privacy of our visitors. This Privacy Policy document contains
          types of information that is collected and recorded by Player Fan and
          how we use it.
        </Paragraph>
        ...
        <Paragraph>We are a Data Controller of your information.</Paragraph>

        <Paragraph>
          Player Fan legal basis for collecting and using the personal
        ...
        <ul>
          <li>Player Fan needs to perform a contract with you</li>
          <li>You have given Player Fan permission to do so</li>
          <li>
            Processing your personal information is in Player Fan legitimate
            interests
          </li>
          <li>Player Fan needs to comply with the law</li>
        </ul>

        <Paragraph>
          Player Fan will retain your personal information only for as long as
        ...
        <Paragraph>
          Player Fan follows a standard procedure of using log files. These
        ...
        <Paragraph>
          Like any other website, Player Fan uses 'cookies'. These cookies are
        ...
        <Paragraph>
          ...
          advertising partners of Player Fan.
        </Paragraph>

        <Paragraph>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Player Fan, which are sent
        ...
        <Paragraph>
          Note that Player Fan has no access to or control over these cookies
        ...
        <Paragraph>
          Player Fan's Privacy Policy does not apply to other advertisers or
        ...
        <Paragraph>
          Player Fan does not knowingly collect any Personal Identifiable
        ...
        <Title>Online Privacy Policy Only</Title>
        ...
        <Paragraph>
          ...
          regards to the information that they shared and/or collect in Player
          Fan. This policy is not applicable to any information collected
