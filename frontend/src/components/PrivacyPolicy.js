...
const PrivacyPolicy = () => {
  return (
    <div>
      <h1>Privacy Policy for Player Fan</h1>

      <p>
        At Player Fan, accessible from player.fan, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by Player Fan and how we
        use it.
      </p>

      <p>
        If you have additional questions or require more information about our
        Privacy Policy, do not hesitate to contact us through email at !!!INSERT
        EMAIL HERE!!!
      </p>
      ...
      <p>
        Player Fan legal basis for collecting and using the personal information
      ...
      <p>
        Player Fan will retain your personal information only for as long as is
      ...
      <p>
        Player Fan follows a standard procedure of using log files. These files
      ...
      <p>
        Note that Player Fan has no access to or control over these cookies that
      ...
      <p>
        ...
        to the information that they shared and/or collect in Player Fan. This
