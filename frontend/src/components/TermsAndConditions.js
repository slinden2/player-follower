...
const TermsAndConditions = () => {
  return (
    <PageContainer title="Terms and Conditions">
      <ContentWrapper>
        <Paragraph>Welcome to Player Fan!</Paragraph>

        <Paragraph>
          These terms and conditions outline the rules and regulations for the
          use of Player Fan's Website, located at www.player.fan.
        </Paragraph>

        <Paragraph>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Player Fan if you do not agree to
        ...
        <Paragraph>
          We employ the use of cookies. By accessing Player Fan, you agreed to
          use cookies in agreement with the Player Fan's{' '}
        ...
        <Paragraph>
          Unless otherwise stated, Player Fan and/or its licensors own the
          intellectual property rights for all material on Player Fan. All
          intellectual property rights are reserved. You may access this from
          Player Fan for your own personal use subjected to restrictions set in
          these terms and conditions.
        </Paragraph>

        <Paragraph>
          The video material and all the titles and descriptions related to the
          videos are not property of Player Fan. The videos and the related
          content are property of NHL and therefore they are not under Player
          Fan's copyright protection.
        </Paragraph>

        <Paragraph>You must not:</Paragraph>
        <ul>
          <li>Republish material from Player Fan</li>
          <li>Sell, rent or sub-license material from Player Fan</li>
          <li>Reproduce, duplicate or copy material from Player Fan</li>
          <li>Redistribute content from Player Fan</li>
        </ul>
        ...
        <Paragraph>
          ...
          Player Fan does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Player Fan,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Player Fan shall
        ...
        <Paragraph>
          Player Fan reserves the right to monitor all Comments and to remove
        ...
        <Paragraph>
          You hereby grant Player Fan a non-exclusive license to use, reproduce,
        ...
        <Paragraph>
          ...
          the hyperlink compensates the absence of Player Fan; and (d) the link
        ...
        <Paragraph>
          ...
          sending an e-mail to Player Fan (<EmailSpan />
        ...
        <Paragraph>
          No use of Player Fan's logo or other artwork will be allowed for
